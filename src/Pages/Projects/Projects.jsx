...
function Projects() {
  ...
  return (
    <div className=" bg-gray-700 py-4 sm:py-8 px-3 sm:px-6 lg:px-8">
                ...
                <div className="p-4">
                  ...
                  <div className="flex space-x-3">
                    <a
                      ...
                      className="flex items-center text-gray-900 hover:text-gray-700 transition-colors duration-200 text-sm font-medium"
                    >
                      <svg
